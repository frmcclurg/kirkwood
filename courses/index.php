               ...
               <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown">
                     ...
                     <ul class="dropdown-menu">
                        ...
                        <li> <a href="admin/private/webProgrammingPrepSheet.docx">Certificate Requirements</a></li>
                     </ul>
                  </li>
         ...
         <!-- <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12" role="navigation"> -->
            <!-- <div class="well"> -->
               <!-- <ul class="nav nav-pills nav-stacked"> -->
                  <!-- <li> <a href="classAdministration.ppt">Administration</a></li> -->
                  <!-- <li> <a href="itenerary.pptx">Itenerary</a></li> -->
               <!-- </ul> -->
            <!-- </div> -->
         <!-- </div> -->
