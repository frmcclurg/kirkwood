...
/**
 * @brief  Allows the page to be relocated from http://localhost to
 *         http://cecert.kirkwood.edu/~frmcclurg/
 * @author Fred R. McClurg, frmcclurg@gmail.com
 * @date   March 14, 2009
 */
function htmlBase()
{
   if ( $_SERVER['HTTP_HOST'] == "cecert.kirkwood.edu" )
   {
      $baseUrl = "/~fmcclurg/";
   }
   else
